...
public class TodayExpenseStrategy implements ExpenseQueryStrategy {
    ...
    public boolean matches(String normalizedText) {
        ...
        String expectedInput = "bugün toplam ne kadar harcadım";
    ...
    public String buildResponse(Long chatId) {
        ...
        return "Bugünün toplam harcaması: " + total + " TL";
    }
